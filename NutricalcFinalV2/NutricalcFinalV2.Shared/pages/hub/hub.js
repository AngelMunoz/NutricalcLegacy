(function () {
    ...
    WinJS.UI.Pages.define("/pages/hub/hub.html", {
        ...
        ready: function (element, options) {
            ...
            var obtenerDietas = 'http://localhost/quinto/integradora/services/nutricalc_api.php?action=mostrarDietas';
            ...
            //var obtenerPacientes = 'http://localhost/quinto/integradora/services/nutricalc_api.php?action=mostrarPacientes';
        ...
        onHeaderInvoked: function (ev) {
            ...
            if (index === 1) {
                Windows.UI.Popups.MessageDialog('Navegando!').showAsync();
            }
        ...
        buscarPaciente: function () {
            var url = 'http://localhost/quinto/integradora/services/nutricalc_api.php';
